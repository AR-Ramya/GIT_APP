					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Git application project",
									"targetURL": "#gitapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gitapp-display": {
								"semanticObject": "gitapp",
								"action": "display",
								"description": "An SAP Fiori cloud deploy application.",
								"title": "Git application project",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gitapp",
									"url": sap.ui.require.toUrl("gitapp")
								}
							}
						}
					}
